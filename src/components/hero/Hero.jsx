...
return <>
            <div className={styles.hero__section}>
                <h1>Hero Section</h1>
                <div className={styles.img__section} onClick={() => {dispatch({ type: 'select_city' })}}>
                    <img src={sectionData.heroImg[0].imgUrl} alt={sectionData.heroImg[0].value} />
                    <h2>{sectionData.heroImg[0].name}</h2>
                </div>
                <div className={styles.img__section} onClick={() => {dispatch({ type: 'select_sea' })}}>
                    <img src={sectionData.heroImg[1].imgUrl} alt={sectionData.heroImg[1].value} />
                    <h2>{sectionData.heroImg[1].name}</h2>
                </div>
                <div className={styles.img__section} onClick={() => {dispatch({ type: 'select_mountain' })}}>
